        ...
        var tetha = 0.0, edgeSize = 30, padding = 0.15;
        ...
        scene.add( sphere1 );
        sphere1.position.set(0.25,0.25,0.25);
        var sphere2 = new THREE.Mesh( geometry1, material1 );
        scene.add( sphere2 );
        sphere2.position.set(0.75,0.75,0.75);
        ...
        function render(){
            ...
            if(tetha > delta){
                ...
                if(head.mesh.position.distanceTo(sphere1.position) < 0.5){
                   ...
                   if(snake.length>2)
                    {
                        length = (snake.length-1)/2;
                        snake.splice(0, length);    
                    } 
                    
                    

                }
                else if(head.mesh.position.distanceTo(sphere2.position) < 0.5){
